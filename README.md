...
Next we trained an Autoencoder Neural Network on the dataset for the creation of a latent space that contains the representation for both classes of bodies.
