...
Next we trained an <b>Autoencoder Neural Network</b> on the dataset for the creation of a latent space that contains the representation for both classes of bodies. For further details on this part [go here](https://github.com/luismautone/AE-FairnessGeometryProcessing).
